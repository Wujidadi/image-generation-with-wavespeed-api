...
SUBMIT_RESPONSE=$(curl --silent --show-error --fail-with-body \
  --request POST \
  --url https://api.wavespeed.ai/api/v3/x-ai/grok-2-image \
...
- [Model Playground](https://wavespeed.ai/models/x-ai/grok-2-image)
- [API Documentation](https://wavespeed.ai/docs/docs-api/x-ai/x-ai-grok-2-image)
