...
- **Endpoint**: `https://api.wavespeed.ai/api/v3/x-ai/grok-imagine-image-v2.0/edit`
- **Polling/result URL**: `https://api.wavespeed.ai/api/v3/predictions/${PREDICTION_ID}/result`
- **Model ID**: `x-ai/grok-imagine-image-v2.0/edit`
...
- **`images`** (`array of string (uri)`, _required_):
  Input image to edit. Accepts at most one image. Supports jpg, jpeg, png, and webp.

- **`prompt`** (`string`, _required_):
  Text instruction describing how to edit the image.
...
SUBMIT_RESPONSE=$(curl --silent --show-error --fail-with-body \
  --request POST \
  --url https://api.wavespeed.ai/api/v3/x-ai/grok-imagine-image-v2.0/edit \
...
- [Model Playground](https://wavespeed.ai/models/x-ai/grok-imagine-image-v2.0/edit)
- [API Documentation](https://wavespeed.ai/docs/docs-api/x-ai/x-ai-grok-imagine-image-v2.0-edit)
