...
SUBMIT_RESPONSE=$(curl --silent --show-error --fail-with-body \
  --request POST \
  --url https://api.wavespeed.ai/api/v3/bytedance/seedream-v4.5/sequential \
...
- [Model Playground](https://wavespeed.ai/models/bytedance/seedream-v4.5/sequential)
- [API Documentation](https://wavespeed.ai/docs/docs-api/bytedance/bytedance-seedream-v4.5-sequential)
