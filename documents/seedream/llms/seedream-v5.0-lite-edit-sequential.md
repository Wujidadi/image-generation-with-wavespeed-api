...
- **`size`** (`string`, _optional_):
  Specify the width and height pixel values of the generated image.
  - Range: `512` to `8192`
...
SUBMIT_RESPONSE=$(curl --silent --show-error --fail-with-body \
  --request POST \
  --url https://api.wavespeed.ai/api/v3/bytedance/seedream-v5.0-lite/edit-sequential \
...
- [Model Playground](https://wavespeed.ai/models/bytedance/seedream-v5.0-lite/edit-sequential)
- [API Documentation](https://wavespeed.ai/docs/docs-api/bytedance/bytedance-seedream-v5.0-lite-edit-sequential)
