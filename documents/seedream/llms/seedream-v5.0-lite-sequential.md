...
- **`size`** (`string`, _optional_):
  Specify the width and height pixel values of the generated image.Total pixel value range: [2560*1440, 4096*4096]
  - Default: `"2048*2048"`
  - Range: `1440` to `8192`
...
SUBMIT_RESPONSE=$(curl --silent --show-error --fail-with-body \
  --request POST \
  --url https://api.wavespeed.ai/api/v3/bytedance/seedream-v5.0-lite/sequential \
...
- [Model Playground](https://wavespeed.ai/models/bytedance/seedream-v5.0-lite/sequential)
- [API Documentation](https://wavespeed.ai/docs/docs-api/bytedance/bytedance-seedream-v5.0-lite-sequential)
