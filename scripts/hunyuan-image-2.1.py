#!/usr/bin/env python3
"""以 WaveSpeed API 呼叫 wavespeed-ai/hunyuan-image-2.1 進行文生圖。

用法範例（於專案根目錄執行）：
    python3 scripts/hunyuan-image-2.1.py
    python3 scripts/hunyuan-image-2.1.py -p prompts/xxx.txt -o output/xxx --size 1280x720 --seed 42 --output-format png
    python3 scripts/hunyuan-image-2.1.py --prompt "A cinematic shot of a city at sunset"
    python3 scripts/hunyuan-image-2.1.py --task-id <任務 ID> -o output/xxx
"""
...
MODEL_ID = "wavespeed-ai/hunyuan-image-2.1"
