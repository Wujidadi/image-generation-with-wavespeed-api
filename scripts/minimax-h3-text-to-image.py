#!/usr/bin/env python3
"""以 WaveSpeed API 呼叫 wavespeed-ai/minimax-h3/text-to-image 進行文生圖。

用法範例（於專案根目錄執行）：
    python3 scripts/minimax-h3-text-to-image.py
    python3 scripts/minimax-h3-text-to-image.py -p prompts/xxx.txt -o output/xxx --aspect-ratio 16:9 --resolution 2k
    python3 scripts/minimax-h3-text-to-image.py --prompt "A cinematic shot of a city at sunset"
    python3 scripts/minimax-h3-text-to-image.py --task-id <任務 ID> -o output/xxx
"""
...
MODEL_ID = "wavespeed-ai/minimax-h3/text-to-image"
ASPECT_RATIOS = [
