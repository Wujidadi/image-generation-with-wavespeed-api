#!/usr/bin/env python3
"""以 WaveSpeed API 呼叫 google/nano-banana-pro/text-to-image 進行文生圖。

用法範例（於專案根目錄執行）：
    python3 scripts/nano-banana-pro-text-to-image.py
    python3 scripts/nano-banana-pro-text-to-image.py -o output/xxx --aspect-ratio 16:9 --resolution 2k
    python3 scripts/nano-banana-pro-text-to-image.py --prompt "A cinematic shot of a city at sunset"
    python3 scripts/nano-banana-pro-text-to-image.py --task-id <任務 ID> -o output/xxx
"""
