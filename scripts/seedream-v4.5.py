#!/usr/bin/env python3
"""以 WaveSpeed API 呼叫 bytedance/seedream-v4.5 進行文生圖。

用法範例（於專案根目錄執行）：
    python3 scripts/seedream-v4.5.py
    python3 scripts/seedream-v4.5.py -p prompts/xxx.txt -o output/xxx --size 1440x2560
    python3 scripts/seedream-v4.5.py --prompt "A cinematic shot of a city at sunset"
    python3 scripts/seedream-v4.5.py --task-id <任務 ID> -o output/xxx
"""
...
MODEL_ID = "bytedance/seedream-v4.5"
