#!/usr/bin/env python3
"""以 WaveSpeed API 呼叫 alibaba/wan-2.5/text-to-image 進行文生圖。

用法範例（於專案根目錄執行）：
    python3 scripts/wan-2.5-text-to-image.py
    python3 scripts/wan-2.5-text-to-image.py -p prompts/xxx.txt -o output/xxx --size 1440x1440 --enable-prompt-expansion
    python3 scripts/wan-2.5-text-to-image.py --prompt "A cinematic shot of a city at sunset"
    python3 scripts/wan-2.5-text-to-image.py --task-id <任務 ID> -o output/xxx
"""
...
MODEL_ID = "alibaba/wan-2.5/text-to-image"
